...
const Banner = ({ title, prefix }: {| title: Node, prefix: string |}) => (
  <div className="container p-4 p-lg-7 my-7">
    <div className="row m-0 w-100 flex-column justify-content-center align-items-center">
      ...
      <RequestDemoButton buttonClassName="btn-red text-lg px-4 py-2" prefix={prefix} />
    </div>
  </div>
);
...
export const CTABanner = ({ location, prefix }: LayoutProps) => {
  ...
  return <Banner title={experiment.title} prefix={prefix} />;
};
