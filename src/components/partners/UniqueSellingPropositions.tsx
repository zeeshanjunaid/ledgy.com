...
const readMoreWrapperClasses = 'col-10 offset-1 col-md-8 offset-md-2 col-lg-4 offset-lg-0 mb-4 mb-md-6 my-lg-4';
const ulClasses = 'width-fit-content text-left pb-0 mb-0 mx-auto';

export const UniqueSellingPropositions = () => <div className="partner-usp container pt-6 pb-4">
    ...
    <div className="row gap-y text-center my-5">
      <div className={readMoreWrapperClasses}>
        <ReadMore icon={faCompass} title={<Trans>Single source of truth</Trans>} subtitle={<ul className={ulClasses}>
              <li>
      ...
      <div className={readMoreWrapperClasses}>
        <ReadMore icon={faChartLine} title={<Trans>Powerful modeling insights</Trans>} subtitle={<ul className={ulClasses}>
              <li>
      ...
      <div className={readMoreWrapperClasses}>
        <ReadMore icon={faDollarSign} title={<Trans>Faster due diligence</Trans>} subtitle={<ul className={ulClasses}>
              <li>
