...
export const PartnerCard = (props: {logo: {
    [key: string]: any;
  ...
  return <div className="col col-12 col-md-6 col-lg-3 mb-6">
      <div className="partner-card card border shadow-8 p-4 mx-auto text-center" key={website}>
        ...
        <div className="h-20 d-flex justify-content-around pt-2">
          <a className="align-content-center" href={`mailto:${email}?subject=Inquiry from Ledgy Partner Page`} {...targetBlank}>
