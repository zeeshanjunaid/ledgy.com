...
export const OtherCustomerStories = ({
  ...
  return <>
      ...
      <div className="row align-items-center justify-content-center mb-4">
        {sampleSize(customerStories, 3).map(customerStory => <div key={customerStory.id} className="col-md-4 col-lg-3">
      ...
      <div className="row m-0 w-100 justify-content-center align-items-center">
        <a className="btn btn-xl btn-round btn-primary align-self-center" href={`${prefix}/customer-stories`}>
          View all
        </a>
      </div>
    </>;
