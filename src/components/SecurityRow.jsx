  ...
  <div className="row gap-y text-center">
    ...
    <div className="col-md-6 col-xl-5 offset-xl-1">
      ...
      <p>
        ...
        <br />
        <Link href to={`${props.prefix}/privacy/`}><Trans>Read more</Trans><FontAwesomeIcon icon={faChevronRight} className="fs-12 ml-2" /></Link>
      </p>
    </div>
    ...
    <div className="col-md-6 col-xl-5">
      ...
      <p>
        ...
        <br />
        <Link href to={`${props.prefix}/security/`}><Trans>Read more</Trans><FontAwesomeIcon icon={faChevronRight} className="fs-12 ml-2" /></Link>
      </p>
    </div>
  </div>
);
