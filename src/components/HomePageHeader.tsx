...
export const HomePageHeader = ({
  ...
  return <MainHeaderLayout title={title} subtitle={subtitle} buttonOne={<RequestDemoButton prefix={prefix} buttonClassName="my-sm-0 my-2 btn-xl d-inline mx-1 btn-red" />} buttonTwo={<Button href={demoUrl} className="btn-xl mx-1 align-self-center" inverted>
          <Trans>Take the tour</Trans>
        </Button>} image={<div id="laptop-ledgy" className="mt-sm-4 mt-xl-0">
