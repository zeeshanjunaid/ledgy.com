...
const PricingCTA = ({
  title,
  description
}: {title: Node;description: Node;}) => <div className="col-12 col-lg-6 col-xl-4">
    <h5>{title}</h5>
...
const CompanyPricing = ({
  ...
  return <>
      ...
      <LedgyPricing launchPlanButton={<Button outline inverted className="my-4" href={`${appUrl}/signup`}>
            <Trans>Sign up</Trans>
          </Button>} growthPlanButton={<Button outline inverted className="mt-4 mb-1" href={`${appUrl}/signup`}>
            <Trans>Sign up</Trans>
          </Button>} growthPlanText="7-day free trial" scalePlanButton={<RequestDemoButton prefix={prefix} buttonClassName="my-4 btn-red" />} highlightScalePlan DynamicTrans={DynamicTrans} t={dynamicI18n} />
      <hr className="my-8" />
