...
3. There are some some parts to decide and adjust. The respective guides will help you
...
7. On Ledgy
    * Create options or phantom option transactions from the pool to your employees (Premium package only)
