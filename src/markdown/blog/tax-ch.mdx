...
A startup’s shares has a certain value and thus needs to be declared by the shareholders in their tax declaration yearly. Here’s a mini guide of how to communicate the equity’s value to your startup’s investors and employees so that they can correctly declare it to the tax office. All the explanations below are only valid for non-listed companies.
...
_***Thanks*** to Monica Maurer from [Audit & Tax AG](https://www.act-ag.ch) for answering our questions about how to calculate the tax value of startups equity._
