...
> Visit [demo.ledgy.com](https://demo.ledgy.com) to see the blockchain notary live in action. Go to the Documents page and upload a PDF file. That’s it.
...
The Curve25519 public key for all certificates is represented in Base64 as

gs04X1XPvYqg0zlsXCcRj+ZvxeHjqOBg1Ac8PZB4UR0=
